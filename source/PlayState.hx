...
class PlayState extends MusicBeatState
{
	...
	var dialogue:Array<String> = ['default dialogue', 'goes brrrrrrr'];
       ...
       // noteweekhex = mcontrols.noteweekhex;
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'dadbattle':
				dialogue = [
					...
					"Only then I will even\n CONSIDER letting you date my daughter!"
				];
			case 'senpai':
			...
			case 'casanova':
				dialogue = CoolUtil.coolTextFile(Paths.txt('casanova/dialogue'));
			case 'worship':
			...
			case 'gospel':
				dialogue = CoolUtil.coolTextFile(Paths.txt('gospel/dialogue'));
			case 'roses':
			...
			case 'foolhardy-retrospecter':
				dialogue = CoolUtil.coolTextFile(Paths.txt('foolhardy-retrospecter/DIALOGUE'));
			case 'wocky':
		...
		switch (SONG.song.toLowerCase())
		{
				  ...
				  { 
				    defaultCamZoom = 0.9;
				    curStage = 'church2';
				    var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('church2'));
				    bg.antialiasing = true;
				    bg.scrollFactor.set(0.9, 0.9);
				    bg.active = false;
				    add(bg);
				  ...
				  case 'zavodila':
				  {
				    defaultCamZoom = 0.9;
				    curStage = 'church3';
				    var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('church3'));
				    bg.antialiasing = true;
				    bg.scrollFactor.set(0.9, 0.9);
				    bg.active = false;
				    add(bg);
				  ...
				  case 'casanova':
				  {
				    defaultCamZoom = 0.9;
				    curStage = 'church5';
				    var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('church5'));
				    bg.antialiasing = true;
				    bg.scrollFactor.set(0.9, 0.9);
				    bg.active = false;
				    add(bg);
				  ...
				  case 'gospel':
				  {
				    defaultCamZoom = 0.9;
				    curStage = 'church4';
				    var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('church4'));
				    bg.antialiasing = true;
				    bg.scrollFactor.set(0.9, 0.9);
				    bg.active = false;
				    add(bg);
				  ...
				  case 'parish':
				  {
				    defaultCamZoom = 0.9;
				    curStage = 'church1';
				    var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('church1'));
				    bg.antialiasing = true;
				    bg.scrollFactor.set(0.9, 0.9);
				    bg.active = false;
				    add(bg);
				  }
				  case 'foolhardy' | 'foolhardy-retrospecter':
				  {
			        defaultCamZoom = 0.9;
					curStage = 'maze';
				  ...
				  case 'popipo' | 'aishite' | 'siu' | 'disappearance':
				  {
				    defaultCamZoom = 0.7;
				    curStage = 'mikustage';
				    var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('stagebackMiku'));
				    bg.antialiasing = true;
				    bg.scrollFactor.set(0.9, 0.9);
				    bg.active = false;
				    add(bg);
				  ...
				  case 'norway':
				  {
					defaultCamZoom = 0.9;
					curStage = 'eddhouse1';
					var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('tordBGnorway'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
				    add(bg);
				  ...
				  case 'tordbot':
				  {
					defaultCamZoom = 0.9;
					curStage = 'eddhouse2';
					var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('tordBGbot'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
				    add(bg);
				  }
				  case 'headache' | 'nerves' | 'release':
				  {
					defaultCamZoom = 0.7;
					curStage = 'alley';
					var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('garStage'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
				    add(bg);
				  ...
				  case 'gacha-life':
				  {
					defaultCamZoom = 1.3;
					curStage = 'gacha';
					var bg:FlxSprite = new FlxSprite(-198.05, -10.6).loadGraphic(Paths.image('bgGACHA'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.2, 0.8);
					bg.active = false;
					add(bg);

					var floor:FlxSprite = new FlxSprite(-198.05, 414.15).loadGraphic(Paths.image('floorGACHA'));
				  ...
				  case 'wocky' | 'beathoven':
				  {
						defaultCamZoom = 0.9;
						curStage = 'arcade';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('stagebackKAPI'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);
				  ...
				  case 'flatzone':
				  {
						defaultCamZoom = 0.9;
						curStage = 'flatzone';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('flatzoneBG'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);
				  ...
				  case 'screenplay' | 'parasite':
				  {
					    defaultCamZoom = 0.9;
						curStage = 'void1';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('void1'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);
				  ...
				  case 'a.g.o.t.i':
				  {
					  defaultCamZoom = 0.9;
					  curStage = 'void2';
					  var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('void2'));
...
//middle shit
	...
	{
		var mikuHi:FlxSprite = new FlxSprite(100, -100);
		mikuHi.frames = Paths.getSparrowAtlas('mikuintro');
		mikuHi.animation.addByPrefix('idle', 'miku intro instance 1', 24, false);
		mikuHi.updateHitbox();
		add(mikuHi);
		dad.alpha == 0;
	...
	function assIntro(?dialogueBox:DialogueBox):Void
	{
			...
			agotiAngry.frames = Paths.getSparrowAtlas('Agoti_Cutscene_B');
			agotiAngry.animation.addByPrefix('idle', 'Agoti_Cut_B', 24, false);
            agotiAngry.updateHitbox();
			add(agotiAngry);
			dad.alpha = 0;
			...
			camHUD.visible = false;
			agotiAngry.animation.play('idle');
	...
	function rageIntro(?dialogueBox:DialogueBox):Void
	{
			var mikuangery:FlxSprite = new FlxSprite(100, -100);
			mikuangery.frames = Paths.getSparrowAtlas('mikumadone');
			mikuangery.animation.addByPrefix('idle', 'miku intro challenge 1', 24, false);
			mikuangery.updateHitbox();
			add(mikuangery);
	
			inCutscene = true;
	
			camHUD.visible = false;
			mikuangery.animation.play('idle');
			dad.alpha == 0;
	...
	override public function update(elapsed:Float)
	{
		...
		if (scaryasfuk && dad.animation.curAnim.name == 'singLEFT' && dad.curCharacter == 'zardy' || scaryasfuk && dad.animation.curAnim.name == 'singRIGHT' && dad.curCharacter == 'zardy' || scaryasfuk && dad.animation.curAnim.name == 'singUP' && dad.curCharacter == 'zardy' || scaryasfuk && dad.animation.curAnim.name == 'singDOWN' && dad.curCharacter == 'zardy' )
	    {
			gf.playAnim('scared');
		}
		#if !debug
	...
	override function stepHit()
	{
		...
		if (SONG.song.toLowerCase() == 'foolhardy' || SONG.song.toLowerCase() == 'foolhardy-retrospecter')
	    {
			if (curStep == 60)
			{
				scaryasfuk = true;
